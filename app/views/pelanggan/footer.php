    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL; ?>/pelanggan/tambah" method="POST" class="needs-validation" novalidate>
...
<div class="modal fade" id="editPelanggan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL; ?>/pelanggan/edit" method="POST" class="needs-validation" novalidate>
...
<script>
    ...
    $(document).ready(function() {
        ...
        tablePelanggan.on('order.dt search.dt', function() {
            tablePelanggan.column(0, {
                search: 'applied',
                order: 'applied'
        ...
        $('.btnEditPelanggan').click(function() {
            var id = $(this).data('id');
